...
2. 목적, 항목, 기간, 당사자, 대금, 해지 등 핵심 값을 구조화합니다.
3. 값이 비어 있거나 지나치게 포괄적인 경우 구체성 검토로 표시합니다.
4. 민감정보, 고유식별정보 및 약관법 관련 검토 신호를 표시합니다.
5. 각 결과에 심각도, 탐지 신뢰도, 조문과 국가법령정보센터 링크를 제공합니다.
6. 주민등록번호, 전화번호, 이메일을 결과에서 마스킹합니다.
7. Markdown 및 JSON 보고서를 다운로드할 수 있습니다.
